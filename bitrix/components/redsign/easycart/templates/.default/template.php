		...
		?><div class="rsec_in"><?
			?><div class="rsec_body"><?
				?><div class="rsec_tyanya"><?
					...
					?><a class="rsec_close" href="#close"><i class="rsec_iconka"></i></a><?
				?></i></div><?
				?><div class="rsec_tabs"><?
	...
	?><div class="rsec rsec_headers"><?
		?><div class="rsec_in" <?if(IntVal($arParams['MAX_WIDTH'])>1):?>style="max-width:<?=IntVal($arParams['MAX_WIDTH'])?>px;"<?endif;?>><?
			?><div class="rsec_body"><?
				...
				{
					?><a class="rsec_online" href="<?=($arParams['ONLINE_CONSUL_LINK']!=''?$arParams['ONLINE_CONSUL_LINK']:"#")?>"><i class="rsec_iconka"></i><span class="rsec_name">online consultant</span></a><?
				}
				if( $arParams['USE_VIEWED']=='Y' )
				{

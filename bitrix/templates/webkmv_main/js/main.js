$(document).ready(function() {
    ...
    $(".header ul.nav li").hover(function() {
        $(this).find("i").show();
        $(".submenuMe #"+$(this).attr("class")).toggle();
    ...
    $(".submenuMe ul").hover(function() {
        $(this).show();
        $(".header ul.nav li."+$(this).attr("id") +" i").show();
    }, function() {
        $(this).hide();
        $(".header ul.nav li."+$(this).attr("id") +" i").hide();
    ...
    $('<a style="margin-right: 10px;" href="http://support.web-kmv.ru/" class="lkenter"></a><div class="clear"></div>').insertAfter(".phone-block");
			...
			$.ajax({
				...
				success:function(data) {
                    if(data == 'Y') {
                        ...
                        $(".form_mainer").html("<div class='thx_for_mail'></div>");
                        $(".form-inp").html("");
                    } else if(data == 'N') {
                        alert("Код с картинки введен неправильно.");
                    }
				}
			});
...
// Код кнопки прикрепить
    ...
    $(".foot-address").text("г. Пятигорск, ул. Панагюриште, 4 , офис 187.");
    $(".phone-foot").html("8(962) <span>028-36-87</span>");
    $(".phone").html("<span class='phone-town'>г. Пятигорск </span>8(962) <span>028-36-87</span>");


    $(".open-me").click(function () {
        $(".splblock").fadeToggle(500);
    });
    ...
    $(".open-me2").click(function () {
        $(".splblock2").fadeToggle(500);
    });
    $(".close-me2").click(function () {
        $(".splblock2").fadeToggle(500);
    });

    $(".open-me3").click(function () {
        $(".splblock3").fadeToggle(500);
    });
    $(".close-me3").click(function () {
        $(".splblock3").fadeToggle(500);
    });

    $(".open-me4").click(function () {
        $(".splblock4").fadeToggle(500);
    });
    $(".close-me4").click(function () {
        $(".splblock4").fadeToggle(500);
    });

...
<div class="search-page">
	...
	<form class="bl_find clear_fix" action="" method="get">
		<input class="bl_find_t" type="text" name="q" value="<?=$arResult["REQUEST"]["QUERY"]?>"  />
...
<?elseif($arResult["ERROR_CODE"]!=0):?>
	...
	<h3 style="color: red"><?=$arResult["ERROR_TEXT"];?></h3>

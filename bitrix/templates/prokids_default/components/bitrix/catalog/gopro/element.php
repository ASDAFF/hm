...
<?php if (isset($_SERVER['HTTP_X_REQUESTED_WITH']) || $_REQUEST['debug'] == 'yes'): ?>
	...
	<?php if ($_REQUEST['AJAX_CALL'] == 'Y' && $_REQUEST['action'] == 'rsgppopup' && $ELEMENT_ID > 0): ?>
        <?php
		// +++++++++++++++++++++++++++++++ get element popup +++++++++++++++++++++++++++++++ //
		global $APPLICATION;
		...
		die();
        ?>
	<?php elseif ($arParams['USE_COMPARE'] == 'Y' && $_REQUEST['AJAX_CALL'] == 'Y' && ($_REQUEST['action'] == 'ADD_TO_COMPARE_LIST' || $_REQUEST['action'] == 'DELETE_FROM_COMPARE_LIST') ): ?>
        <?php
		// +++++++++++++++++++++++++++++++ add2compare +++++++++++++++++++++++++++++++ //
		...
		die();
        ?>
	<?php elseif ($_REQUEST['AJAX_CALL'] == 'Y' && $_REQUEST['action'] == 'add2favorite' && $ELEMENT_ID > 0): ?>
		...
		die();
		?>
	<?php elseif ($_REQUEST['AJAX_CALL'] == 'Y' && $_REQUEST['action'] == 'add2basket'): ?>
        <?php
		// +++++++++++++++++++++++++++++++ add2basket +++++++++++++++++++++++++++++++ //
		global $APPLICATION, $JSON;
		...
		die();
        ?>
	<?php elseif ($_REQUEST['AJAX_CALL'] == 'Y' && $_REQUEST['action'] == 'get_element_json'): ?>
		<?php
        global $APPLICATION, $JSON;
		$APPLICATION->RestartBuffer();
...
<?php if ($IS_AJAXPAGES == 'Y' || $IS_SORTERCHANGE == 'Y'): ?>
    <?php
	$APPLICATION->RestartBuffer();
	if(SITE_CHARSET!='utf-8') {
		$data = $APPLICATION->ConvertCharsetArray($JSON, SITE_CHARSET, 'utf-8');

...
{
	?><div class="aroundjssorslider1"><?
		?><div id="jssor_slider1" style="position:relative;top:0px;left:0px;width:990px;height:<?=$arParams['RSGOPRO_BANNER_HEIGHT']?>px;"<?if(count($arResult['ITEMS'])==1):?> class="hidecontrols"<?endif;?>><?
			?><div u="slides" class="slides" style="cursor:move;position:absolute;left:0px;top:0px;width:990px;height:<?=$arParams['RSGOPRO_BANNER_HEIGHT']?>px;overflow:hidden;"><?
			...
			?></div><?
			?><span u="arrowleft" class="prev" style="width:65px;height:65px;top:123px;left:0px;"><span><i class="icon pngicons"></i></span></span><?
			?><span u="arrowright" class="next" style="width:65px;height:65px;top:123px;right:0px"><span><i class="icon pngicons"></i></span></span><?
			?><div u="navigator" class="navi"><?
